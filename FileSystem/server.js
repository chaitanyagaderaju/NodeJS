...
// fs.writeFile("demo.txt","Hii Chaitanya",(err)=>{
// if(err) throw err;
// else{
...
// fs.appendFile("demo.txt","NodeJS server",(err,res)=>{
//     if(err) throw err;
//     else{
        ...
        if(err) throw err;
            ...
            fs.readFile("new1.txt",(err,res)=>{
                if(err) throw err;
                    ...
                    // 10) write the data
                    fs.writeFile("new1.txt","chaitanya gaderaju",(err)=>{
                        if(err) throw err;
                        else{
                            console.log("write the data succesfully");
                            // 11)truncate operation
                              fs.truncate("new1.txt",6,(err)=>{
                                if(err) throw err;
                                else{
